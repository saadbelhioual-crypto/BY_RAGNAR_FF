...
def add_log(message, log_type="INFO"):
    """Add log message to buffer with colors"""
    timestamp = time.strftime("%H:%M:%S")
    colored_logs = {
        "INFO": f"\033[36m[INFO]\033[0m",      # Cyan
        "SUCCESS": f"\033[32m[SUCCESS]\033[0m", # Green
        "ERROR": f"\033[31m[ERROR]\033[0m",     # Red
        "WARNING": f"\033[33m[WARNING]\033[0m", # Yellow
        "BOT": f"\033[35m[BOT]\033[0m",         # Purple
    }
...
def read_process_output(pipe, is_error=False):
    """Read and log bot output in real-time"""
